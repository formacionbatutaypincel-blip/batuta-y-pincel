    ...
    <section className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <button
              ...
              className={`flex items-center gap-2 px-5 py-2.5 rounded-full text-sm font-semibold transition-all ${
                categoriaActiva === cat.id
                  ? "bg-[#25AFE6] text-white shadow-md scale-105"
        ...
        <p className="text-center text-gray-400 text-sm mb-8">
          Mostrando <span className="font-bold text-[#25AFE6]">{fotosFiltradas.length}</span> {fotosFiltradas.length === 1 ? "foto" : "fotos"}
                ...
                <div className="absolute inset-0 bg-black/0 group-hover:bg-black/20 transition-all duration-300 flex items-center justify-center">
                  <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <div className="bg-white rounded-full p-3 shadow-lg">
                      <svg className="w-5 h-5 text-[#25AFE6]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-16 bg-orange-50 border-2 border-orange-200 rounded-2xl p-6 text-center">
          ...
          <Link
            href="/contacto"
            className="inline-flex items-center gap-2 bg-[#25AFE6] hover:bg-[#1A8FB8] text-white px-6 py-2.5 rounded-full font-bold text-sm transition-all"
          >
